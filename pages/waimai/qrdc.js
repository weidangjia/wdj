...
Page({
  ...
  //     })
  //   } else if (e.detail.errMsg =='getPhoneNumber:fail 该 appid 没有权限'){
  //     my.setStorageSync('userPhone', 'appid没有权限');
  //     that.setData({
  //       phone: 'appid没有权限'
  //     })
  //     return;
  ...
  //       success: function (r) {
  //         if(r.code){
  //           config.post('wxApi/xcx/updatePhone', {
  //             encryptedData: e.detail.encryptedData,
  //             iv: e.detail.iv,
  //             code: r.code
  //             },function(ret){
  //               if(ret.code==0){
  //                 my.setStorageSync('userPhone', ret.msg)
  //                 that.setData({
  //                   phone:ret.msg
  //                 })
